...
# Update generate_comparisons.py script in l2cache-site
l2cache_site_dir = "/Users/dinesh/tech/l2cache-site"
comp_script_path = os.path.join(l2cache_site_dir, "generate_comparisons.py")

script_content = f'''#!/usr/bin/env python3
import os
import json

COMPETITORS = {json.dumps(COMPETITORS_UPDATE, indent=4)}
...
with open(comp_script_path, "w", encoding="utf-8") as f:
    f.write(script_content)

print(f"Updated {comp_script_path} with all 7 competitor comparisons!")
