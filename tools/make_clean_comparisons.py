...
comp_dict_str = json.dumps(COMPETITORS_UPDATE, indent=4)

clean_script = f'''#!/usr/bin/env python3
import os
import json

COMPETITORS = {comp_dict_str}
...
print("Wrote generate_comparisons.py successfully!")
